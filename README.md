...
- 🗒️Exported files from MAL and 9anime ```Please mark "Group by folder" in 9anime when exporting```

### HOW TO USE  

- 🗒️You will need to get yours 9anime export in TXT file - ```Group by folder```
